					...
					<div id="id00" class="modal">		  
					  <form class="modal-content animate" method = "post" action="./processRegister.php">
					    <div class="container">		      
						    ...
						    <input id="pass2" type = "password" placeholder="Confirm Password" name = "user_pass_check" required>
						    <label><b>Email</b></label>
						    <input required type = "email" placeholder="Enter Email" name = "user_email"  required>
